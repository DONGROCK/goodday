...
<button onclick="location.href='${pageContext.servletContext.contextPath}/employee/list'">직원정보 전체 조회하기</button>
...
<h3>EMPLOYEE 테이블에서 직원 정보 수정 (사번과 변경할 정보를 입력 받아 사번과 일치하는 사원의 정보 변경 - 원하는 데이터 변경) : /employee/update (post)</h3>
...
<h3>EMPLOYEE 테이블에서 직원 정보 삭제 (사번 입력 받아 사번과 일치하는 행 삭제) : /employee/delete (post)</h3>
