...
public class ResolverController {
    ...
    public String stringReturing(Model model) {
        ...
        * ThymeleafViewResolver에게 resources/template/ 를 prifiex로 .html를 suffix로 하여
        * resources/template/result.html 파일을 응답 뷰로 설정하라는 의미가된다.
        * */
        return "result";
    }
    ...
    public String stringRedirect() {
        /* 접두사로 redirect:을 하면 forword가 아닌 redirect이다.*/
        return "redirect:/";
    }

    /*
    * 기본적으로 redirect시에는 재용청이 발생하므로 request scope는 소멸된다.
    ...
    * 이 때 문자열을 반환해도 되지만 ModelAndView를 미리 만들어서 반환할 수 도 있다.
    * */
