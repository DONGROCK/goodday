...
// DispatcherServlet은 웹 요청을 받는 즉시 @Controller가 달린 컨트롤로 클래스에 처리를 위임한다.
...
public class MethodMappingTestController {
    ...
    public String registMenu(Model model) {
        ...
        // resources/template 하위부터의 경로를 작성
    ...
    // PATCH                    @PatchMapping
    // 이 어노테이션들은 @RequestMapping 어노테이션에 method속성을 사용하여 요청 방법을 지정하는 것과 동일하다.
