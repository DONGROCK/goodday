...
public class ResolverController {
    ...
    public String stringReturing(Model model){
        ...
        model.addAttribute("forwardMessage", "문자열로 뷰 이르 반환함..");

        /*
        * 문자열로 뷰 이름을 반환 한다는 것은 반환 후에
        * ThymeleafViewResolver에게 resources/tmplates/ 를 prifix로 .html을 suffix로 하여
        * resources/template/result.html 파일을 응답 뷰로 설정하라는 의미가 된다.
        * */
    ...
    public String stringRedirect(){
        ...
        /*접두사로 redirect: 을 하면 forward가 아닌 redirect이다.*/
        return "redirect:/";
    }
    ...
    * */
    ...
    public String stringRedirectFlashAttribute(RedirectAttributes rttr){
        ...
        * 세션에 임시로 값을 담고 소멸하는 빙식이기 때문에 session에 동일한 키 값이 존재하지 앉아야 한다.
        * */
    ...
    * 이 때 문자열을 반환해도 되지만 ModelAndView를 미리 만들어서 반환할 수 도 있따.
    * */
