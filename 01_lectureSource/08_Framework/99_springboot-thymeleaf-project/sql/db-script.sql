-- DB에 추가 시 계정 추가
-- CREATE DATABASE thymeleafspringboot;
-- CREATE USER 'ohgiraffers'@'%' IDENTIFIED BY  'ohgiraffers'; 
-- GRANT ALL PRIVILEGES ON thymeleafspringboot.* TO 'ohgiraffers'@'%';

USE thymeleafspringboot;
...
COMMIT;
-- 일반 계정 추가(test01test01)
INSERT INTO TBL_MEMBER (MEMBER_ID, MEMBER_PWD, NICKNAME, PHONE, EMAIL, MEMBER_ROLE) VALUES ('test01', '$2a$10$u10wOwCdHvobI8bvanMoHOlte9rrzGyc906iQlHuUMT3Tzt2aePG', '오지라퍼', '01012345678', 'test01@ohgiraffers.com', 'ROLE_MEMBER');
COMMIT;
