...
import com.ohgiraffers.thymeleafspringboot.board.model.service.BoardServiceImpl;
...
public class ThumbnailController {
    ...
    @PostMapping("/regist")
    public String registThumbnail(@ModelAttribute BoardDTO thumbnail,
    ...
    @GetMapping("/detail")
    public String selectThumbnailDetail(@RequestParam Long no, Model model) {
