package com.ohg.security.auth.model.dto;
 ...
 * 반환되는 사용자 타입으로 해당 객체에 조회된 사용자의 정보가 담겨서 session에 저장할 수 있다.
 * */
public class AuthDetails implements UserDetails {
    ...
    /*사용자으미 비밀번호를 반환하는 메소드
    * UsernamePasswordAuthenticationToken 에 사용자으 ㅣ권한 정보를 넣을 때 사용된다.
    * */
    @Override
    ...
    * false이면 해당 계정을 사용할 수 없다.
    *
    * 비밀번호 반복 실패로 일시적인 계정 lock과 같은경우
    * 혹은 오랜기간 비접속으로 휴면처리
    * */
    @Override
    ...
    * false이면 해당 계정을 사용할 수 없다.
    *
    * 보통 데이터 삭제는 즉시하는 것이 아닌 일정 기간 보환 후 삭제를 한다.
    * */
    @Override
